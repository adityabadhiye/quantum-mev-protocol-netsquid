...
![eq](https://latex.codecogs.com/svg.image?\bigoplus_{j}&space;Y_{j}&space;=&space;\frac{1}{\pi&space;}\&space;\sum_{j}&space;\theta_{j}&space;\hspace{5mm}&space;&space;\textbf{(mod&space;2)})